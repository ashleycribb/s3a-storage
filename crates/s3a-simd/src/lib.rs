...
use s3a_core::{
    HyperTileHeader, MicroHull, SimplexHull, MAX_HULL_DIMENSIONS, MICRO_HULL_DIMENSIONS,
};
...
pub fn can_reject_tile_time(
    header: &HyperTileHeader,
    query_min_ts: u64,
    query_max_ts: u64,
) -> bool {
